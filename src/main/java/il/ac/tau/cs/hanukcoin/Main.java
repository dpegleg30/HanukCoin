...
public class Main {
    public static void main(String[] args) {
        int wallet = HanukCoinUtils.walletCode("CaptainAmerica");
        Block genesis = HanukCoinUtils.createBlock0forTestStage();
        ArrayList<Block> blocks = HanukCoinUtils.ProvChain(new String[]{"4"});
        System.out.println(validate_chain(blocks));
    }
